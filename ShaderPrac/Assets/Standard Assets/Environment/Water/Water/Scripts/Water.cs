    ...
    public class Water : MonoBehaviour
    {
        ...
        public void OnWillRenderObject()
        {
            ...
            if (mode >= WaterMode.Reflective)
            {
                ...
                //clipPlane 本身是相机空间的
                //外参相关的 是worldToCameraMatrix决定

                //裁剪矩阵 还是用老相机的，影子必须和实体同时被裁剪
                // Set custom culling matrix from the current camera
                reflectionCamera.cullingMatrix = cam.projectionMatrix * cam.worldToCameraMatrix;//cullingMatrix : world to culling space
